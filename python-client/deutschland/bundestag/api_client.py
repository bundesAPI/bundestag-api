...
from deutschland.bundestag import rest
from deutschland.bundestag.configuration import Configuration
from deutschland.bundestag.exceptions import ApiException, ApiTypeError, ApiValueError
from deutschland.bundestag.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.blueprint_servlet_content_articleidas_app_v2_newsarticle_xml_get  # this is an instance of the class Endpoint
        api_instance.blueprint_servlet_content_articleidas_app_v2_newsarticle_xml_get()  # this invokes api_instance.blueprint_servlet_content_articleidas_app_v2_newsarticle_xml_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.blueprint_servlet_content_articleidas_app_v2_newsarticle_xml_get.callable or self.callable in this class
