...
from deutschland.bundestag.exceptions import ApiTypeError, ApiValueError
from deutschland.bundestag.schemas import (
    BinarySchema,
    BoolClass,
    FileIO,
    NoneClass,
...
class ApiClient:
    ...
    def __call_api(
        ...
        # auth setting
        self.update_params_for_auth(headers, auth_settings, resource_path, method, body)
