...
class BaseApi(api_client.Api):
    def _static_appdata_plenum_v2_speaker_xml_get_oapg(
        self: api_client.Api,
...
class StaticAppdataPlenumV2SpeakerXmlGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def static_appdata_plenum_v2_speaker_xml_get(
        self: BaseApi,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
        ...
        return self._static_appdata_plenum_v2_speaker_xml_get_oapg(
