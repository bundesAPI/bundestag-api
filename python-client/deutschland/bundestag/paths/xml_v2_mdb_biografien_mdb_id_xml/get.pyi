...
request_path_mdb_id = api_client.PathParameter(
    name="MDB_ID",
...
class BaseApi(api_client.Api):
    def _xml_v2_mdb_biografien_mdbid_xml_get_oapg(
        self: api_client.Api,
        ...
        _path_params = {}
        for parameter in (request_path_mdb_id,):
...
class XmlV2MdbBiografienMdbidXmlGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def xml_v2_mdb_biografien_mdbid_xml_get(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._xml_v2_mdb_biografien_mdbid_xml_get_oapg(
